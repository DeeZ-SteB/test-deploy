<x-app-layout>
    ...
    <div class="row mb-5">
        <div class="col-3">
            <form data-filter-form="recruiting" action="{{ route('ajax-resumes-parser') }}" method="post">
                @csrf
                @method('POST')
                ...
                <h4 class="mt-5">Salary range</h4>
                <div class="d-flex gap-3">
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text">$</span>
                        </div>
                        <input class="form-control" min="0" type="number" name="salary_from">
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control" type="number" name="salary_to">
                    </div>
                </div>
